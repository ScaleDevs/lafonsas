    ...
    <div>
      <div className={`relative ${w} h-full`}>
        ...
        >
          ...
          <input
            type={type}
            className='w-full h-full py-1 px-2 bg-gray-700 rounded-sm transition-[outline] outline-none duration-500 focus:outline-1 focus:outline-blue-500 hover:outline-blue-400 placeholder:text-sm'
        ...
        {ButtonChildren ? (
          <button
            className='absolute top-0 right-0 bg-blue-500 h-full px-3 hover:bg-blue-400'
